...
def barium3beam_ss(deltag,deltar,lg,lr,B,alphaY,alphaZ,O493Y,O650Y,O493Z,O650Z,O493sigplus,O493sigminus,O650sigplus,O650sigminus):
    #natural decay rate
    gPS = 2*np.pi*15.1
    gPD = 2*np.pi*5.3
    #Lande G-Factors
...
def BaOffDiag(alphaY,alphaZ,O493Y,O650Y,O493Z,O650Z,O493sigplus,O493sigminus,O650sigplus,O650sigminus):
    ###############Barium Dipole Matrix Operators############################
    ##S1/2 to P1/2##
    D20=np.array([0,0,1/np.sqrt(3)])
    D30=np.array([-1/np.sqrt(3),1j/np.sqrt(3),0])
