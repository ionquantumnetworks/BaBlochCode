...
Omgpi = 2*sc.pi*6 #Rabi frequrency of |1> to |3> and |2> to |4>
...
Omrpi = 2*sc.pi*0.0003 #Rabi frequrency of |6> to |3> and |7> to |4>
Omrsp = 2*sc.pi*6#Rabi frequrency of |5> to |3> and |6> to |4>
Omrsm = 2*sc.pi*6 #Rabi frequrency of |7> to |3> and |8> to |4>
#detunings
...
print(wB)
# thefile = open('G:\\Shared drives\\Ions\\Ion Data\\493 and 650 Spectroscopy Scans\\2021\\Run1_14April\\DeltaR_Run1.dat', 'w')
# for item in xr:
#   thefile.write("%s\n" % item)
# thefile.close()
# thefile = open('G:\\Shared drives\\Ions\\Ion Data\\493 and 650 Spectroscopy Scans\\2021\\Run1_14April\\PopP_Run1.dat', 'w')
# for item in yr:
#   thefile.write("%s\n" % item)
# thefile.close()
